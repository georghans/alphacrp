...
export default function SearchesPage() {
  ...
  const [showCreateDialog, setShowCreateDialog] = useState(false) // Declare showCreateDialog
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h1 className="font-mono text-3xl font-bold uppercase tracking-wider text-foreground sm:text-4xl">SEARCHES</h1>
        </div>
        ...
        <div className="flex flex-1 items-center gap-4">
          ...
          <Select value={filterStatus} onValueChange={(v) => setFilterStatus(v as typeof filterStatus)}>
            ...
            <SelectContent className="border-2 border-foreground">
              <SelectItem value="all" className="font-mono text-xs uppercase">ALL</SelectItem>
              <SelectItem value="active" className="font-mono text-xs uppercase">ACTIVE</SelectItem>
              <SelectItem value="inactive" className="font-mono text-xs uppercase">PAUSED</SelectItem>
            </SelectContent>
          </Select>
        </div>
        ...
        <div className="flex items-center gap-0 border-2 border-foreground">
          <Button
            ...
            className={cn(
              ...
              viewMode === "grid" ? "bg-foreground text-background" : "bg-transparent text-foreground hover:bg-accent hover:text-accent-foreground"
            )}
          >
          ...
          <Button
            ...
            className={cn(
              ...
              viewMode === "list" ? "bg-foreground text-background" : "bg-transparent text-foreground hover:bg-accent hover:text-accent-foreground"
            )}
          >
      ...
      {filteredSearches.length > 0 ? (
        ...
        <div className="border-2 border-dashed border-foreground p-16 text-center">
          ...
          <h3 className="mt-6 font-mono text-sm font-bold uppercase tracking-wider text-foreground">NO SEARCHES FOUND</h3>
